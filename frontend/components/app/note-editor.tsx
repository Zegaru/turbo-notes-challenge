...
function NoteEditorForm({
  ...
  const [contentMode, setContentMode] = useState<"edit" | "preview" | "split">("split");
  ...
  return (
    ...
    >
          ...
          {showViewMode ? (
            ...
            <>
              ...
              <Button
                ...
                size="sm"
                onClick={() =>
                  suggestMutation.mutate({ title: title.trim(), content: content.trim() })
                }
      ...
      <div className="scrollbar flex-1 overflow-y-auto p-12 pt-6 flex flex-col relative">
        ...
        {showViewMode ? (
          <>
            ...
            <div
              onClick={() => setEditMode(true)}
              className="mt-8 flex-1 min-h-[200px] cursor-text rounded px-1 -mx-1 hover:bg-black/5 transition-colors"
            >
